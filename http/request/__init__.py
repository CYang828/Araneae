...
from Araneae,utils.url import safe_url_string
...
class Request(LiveObject):
    ...
    def __init__(self, url, callback = None, method = DEFAULT_REQUEST_METHOD, encoding = 'utf8', proxies = None,associate = False,
                 priority = 0, headers = None, data = None, params = None,auth = None,
                 cookies = None,json = None,dont_filter = None, errback = None):
